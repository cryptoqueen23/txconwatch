        ...
        <header className="site-nav">
          <div className="nav-shell">
            <Link
              href="/"
              className="brand"
              aria-label="Texas Contractor Watch home"
            >
              <span className="brand-mark" aria-hidden="true">
                TX
              </span>
              <span className="brand-copy">
                <b>Texas Contractor</b>
                <span>Watch</span>
              </span>
            </Link>
            ...
            <div className="nav-actions">
              <Link href="/companies" className="nav-search">
                Search
              </Link>
        ...
        <footer className="site-footer">
          <div className="footer-grid">
            ...
            <div>
              ...
              <p>
                Texas Contractor Watch documents submitted complaints and public
                records. It is not a court, regulator, law firm, or legal
                finding.
              </p>
            </div>
          </div>
          ...
          <div className="footer-legal">
            Companies may submit a documented response or correction request for
            publication. Consumers may also file formal complaints with the{" "}
            <a
          ...
          >
            Project by{" "}
            <a
              href="https://tree.phoenixsecuritas.com"
              target="_blank"
              rel="noopener noreferrer"
              style={{ fontWeight: 600 }}
            >
              Phoenix Securitas Tech
            </a>
          </div>
        </footer>
      </body>
